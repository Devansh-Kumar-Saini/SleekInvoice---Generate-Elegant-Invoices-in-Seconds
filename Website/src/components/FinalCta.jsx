...
export default function FinalCta() {
  return (
    <section style={{ position: 'relative', zIndex: 1, maxWidth: 1120, margin: '20px auto 100px', padding: '0 24px' }}>
      <div className="sv-reveal" style={{ position: 'relative', overflow: 'hidden', background: 'var(--bg-surface)', border: '1px solid var(--border-hair-strong)', borderRadius: 28, padding: '72px 40px', textAlign: 'center' }}>
        <div style={{ position: 'absolute', top: -140, left: '50%', transform: 'translateX(-50%)', width: 520, height: 320, background: 'var(--amber)', opacity: 0.16, filter: 'blur(110px)', pointerEvents: 'none' }} />
