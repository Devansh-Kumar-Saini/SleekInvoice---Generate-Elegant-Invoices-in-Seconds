export function ForgeMark({ size = 17, fill = '#1A1206' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill={fill} stroke="none" aria-hidden="true" focusable="false">
...
export function UpdatesIcon({ size = 15 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" aria-hidden="true" focusable="false">
